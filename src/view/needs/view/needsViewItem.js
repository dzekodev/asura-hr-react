...
import selectors from 'modules/needs/needsSelectors';

class needsViewItem extends Component {
  valueAsArray = () => {
...
export default connect(select)(needsViewItem);
