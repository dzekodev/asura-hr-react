...
import selectors from 'modules/customers/customersSelectors';

class customersViewItem extends Component {
  valueAsArray = () => {
...
export default connect(select)(customersViewItem);
