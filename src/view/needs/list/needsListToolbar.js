...
class NeedsListToolbar extends Component {
  doExport = () => {
...
function select(state) {
  return {
    ...
    hasPermissionToCreate:
      needsSelectors.selectPermissionToCreate(state),
    hasPermissionToImport:
      needsSelectors.selectPermissionToImport(state),
  };
}

export default connect(select)(NeedsListToolbar);
