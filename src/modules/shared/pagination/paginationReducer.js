...
export default (
  ...
  return (state = initialData, { type, payload }) => {
    ...
    if (type === actions.SELECTEDS_VALIDATE) {
      return {
        ...state,
        selectedValidate: payload || [],
      };
    }
    ...
    if (type === actions.VALIDATE_START) {
      return {
        ...state,
        loading: true,
      };
    ...
    if (type === actions.VALIDATE_SUCCESS) {
      return {
        ...state,
        loading: false,
      };
    ...
    if (type === actions.VALIDATE_ERROR) {
      return {
        ...state,
        loading: false,
      };
