...
function select(state) {
  return {
    ...
    hasPermissionToCreate:
      usersSelectors.selectPermissionToCreate(state),
    hasPermissionToImport:
      usersSelectors.selectPermissionToImport(state),
  };
}

export default connect(select)(usersListToolbar);
