...
class customersListToolbar extends Component {
  doExport = () => {
...
function select(state) {
  return {
    ...
    hasPermissionToCreate:
      customersSelectors.selectPermissionToCreate(state),
    hasPermissionToImport:
      customersSelectors.selectPermissionToImport(state),
  };
}

export default connect(select)(customersListToolbar);
