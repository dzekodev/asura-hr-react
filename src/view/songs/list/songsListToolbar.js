...
class songsListToolbar extends Component {
  doExport = () => {
...
function select(state) {
  return {
    ...
    hasPermissionToCreate:
      songsSelectors.selectPermissionToCreate(state),
    hasPermissionToImport:
      songsSelectors.selectPermissionToImport(state),
  };
}

export default connect(select)(songsListToolbar);
