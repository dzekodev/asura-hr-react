...
import selectors from 'modules/color/colorSelectors';

class colorViewItem extends Component {
  valueAsArray = () => {
...
export default connect(select)(colorViewItem);
