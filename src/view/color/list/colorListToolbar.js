...
class colorListToolbar extends Component {
  doExport = () => {
...
function select(state) {
  return {
    ...
    hasPermissionToCreate: colorSelectors.selectPermissionToCreate(
      state,
    ),
    hasPermissionToImport: colorSelectors.selectPermissionToImport(
      state,
    ),
  };
}

export default connect(select)(colorListToolbar);
