...
import actions from 'modules/color/form/colorFormActions';
import selectors from 'modules/color/form/colorFormSelectors';
...
export default connect(select)(colorForm);
